...
def main():
    ...
    try:
        ...
        if system_summary:
            ...
            # Save results
            output_file = project_root / "data" / "documents" / "anexos_EAF" / "extractions" / "anexo_02_real_generation" / f"anexo2_page79_system_summary_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
